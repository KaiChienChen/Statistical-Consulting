...
-   **Johansen Test** is used to detect multiple cointegrating relationships.
-   Does not require pre-specifying the number of cointegrating vectors.
...
-   Example of conducting Johansen test on simulated data.
